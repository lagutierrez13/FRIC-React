...
class FindingTypeTable extends Component {
  constructor(props) {
    super(props);
  ...
  onSubmit(e) {
    ...
    const newHistory = {
      action: "Finding type table changed",
      analyst: "",
    };
    ...
    return (
      <Col md={6} sm={6} xs={12}>
        <XPanel visible={panelVisible} onHide={onHide}>
          <XPanel.Title title="Finding Type Table">
...
export default FindingTypeTable;
