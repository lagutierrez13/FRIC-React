...
class ConfidentialityTable extends Component {
  constructor(props) {
    super(props);
  ...
  onSubmit(e) {
    ...
    const newHistory = {
      action: "Confidentiality table changed",
      analyst: "",
    };
    ...
    return (
      <Col md={6} sm={6} xs={12}>
        <XPanel visible={panelVisible} onHide={onHide}>
          <XPanel.Title title="Confidentiality Table">
...
export default ConfidentialityTable;
